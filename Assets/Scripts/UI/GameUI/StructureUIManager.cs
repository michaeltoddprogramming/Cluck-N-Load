...
//     private void Update()
//     {
//         if (activeUI == null || currentSelectedStructure == null)
//             return;

//         // Check if structure destroyed
//         if (currentSelectedStructure.GetCurrentHealth() <= 0)
//         {
//             HideStructureUI();
//             return;
//         }
...
//         // Hide existing UI first
//         if (activeUI != null) HideStructureUI(false);
...
//             activeUIRect.pivot = new Vector2(0.5f, 0.5f);
//             activeUIRect.localScale = Vector3.one;
//             activeUIRect.position = GetScreenPositionAboveStructure(structure) + new Vector3(screenOffset.x, screenOffset.y, 0);
//         }

//         if (activeUI.TryGetComponent<IStructureUI>(out var structureUI))
//         {
//             structureUI.Initialize(structure);
//         }
...
//     public void HideStructureUI(bool playSFX = true)
//     {
//         if (activeUI == null && currentSelectedStructure == null) return;

//         if (playSFX) PlayClosingSFX();
