...
public partial class TutorialManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (instance == null)
        {
            ...
            // Initialize Pete3D integration
            InitializePete3DIntegration();
    ...
    void NextStep()
    {
        ...
        if (currentStepIndex >= 0 && currentStepIndex < steps.Count)
        {
            ...
            if (!string.IsNullOrEmpty(step.stepId) && !GetCompletedStepIds().Contains(step.stepId))
            {
                ...
                // Pete celebrates step completion
                CompleteStepWithPete();
            }
        }
    ...
    private IEnumerator ProcessNextStepSafely()
    {
        try
        {
            ...
            // Integrate Pete3D for this step
            ShowStepWithPete(step);
    ...
    public void EndTutorial()
    {
        ...
        // Hide Pete when tutorial ends
        HidePeteOnTutorialEnd();
