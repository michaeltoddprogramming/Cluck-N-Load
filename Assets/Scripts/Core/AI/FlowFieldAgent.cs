...
public class FlowFieldAgent : MonoBehaviour
{
    ...
    private GridDataGenerator gridDataGenerator; // Add this field
    ...
    private void FindRequiredComponents()
    {
        ...
        gridDataGenerator = FindObjectOfType<GridDataGenerator>(); // Initialize this field
        isInitialized = (gridController != null && flowFieldGenerator != null && gridDataGenerator != null);
    }
    ...
    {
        if (flowFieldGenerator == null) return 0f;
        ...
        // Check for priority flow paths
        Dictionary<Vector2Int, float> flowStrengthMap = flowFieldGenerator.GetFlowStrengthMap();
        if (flowStrengthMap != null && flowStrengthMap.TryGetValue(cellPos, out flowStrength))
        {
            return flowStrength;
        }
        
        // Check for stream influence
        Dictionary<Vector2Int, float> streamInfluenceMap = flowFieldGenerator.GetStreamInfluenceMap();
