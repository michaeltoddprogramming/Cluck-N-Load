...
public partial class TutorialManager
{
    ...
    void InitializeTutorialSteps()
    {
        ...
        steps.Add(new TutorialStep
        {
            ...
            instructionText = "Howdy! I'm Pete. Welcome to the farm!",
            triggerToWaitFor = TutorialTrigger.None,
            peteContext = PeteContext.WorldGuide,
            peteEmotion = PeteEmotion.Excited,
            peteWorldPosition = new Vector3(0, 2, 5) // Center screen, elevated
        });
        ...
        var melonyMovementStep = new TutorialStep
        {
            ...
            instructionText = "Melony's hiding! Use WASD + QE keys, then click her!",
        ...
        steps.Add(new TutorialStep
        {
            ...
            title = "Shop Time",
            instructionText = "Click the shop button to start building!",
        ...
        var farmhouseStep = new TutorialStep
        {
            ...
            instructionText = "Build your Farmhouse first! If destroyed, you lose!",
