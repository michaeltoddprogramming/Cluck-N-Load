...
//     //     // If not reachable, find the blocking object
//     //     obstacleTarget = targetReachable ? null : GetBlockingObjectDirect();
...
//     //     // Calculate destination before intersecting target
//     //     Vector3 direction = (currentTarget.transform.position - transform.position).normalized;

//     //     Collider targetCollider = currentTarget.GetComponent<Collider>();
//     //     float stopDistance = agent.radius + (targetCollider != null ? targetCollider.bounds.extents.magnitude : 0) + 0.1f;

//     //     Vector3 destination = currentTarget.transform.position - direction * stopDistance;

//     //     // Only update if moved far enough
//     //     if ((destination - lastDestination).sqrMagnitude > destinationUpdateThreshold * destinationUpdateThreshold)
//     //     {
...
//     //     // Move to the closest point of the target collider, not its center
//     //     Collider targetCollider = currentTarget.GetComponent<Collider>();
//     //     if (targetCollider != null)
//     //     {
//     //         Vector3 closestPoint = targetCollider.ClosestPoint(transform.position);
//     //         // Only update destination if moved far enough
//     //         if ((closestPoint - lastDestination).sqrMagnitude > destinationUpdateThreshold * destinationUpdateThreshold)
//     //         {
...
//     //     else
//     //     {
//     //         // Fallback to target position if no collider
//     //         Vector3 targetPos = currentTarget.transform.position;
//     //         if ((targetPos - lastDestination).sqrMagnitude > destinationUpdateThreshold * destinationUpdateThreshold)
//     //         {
//     //             agent.SetDestination(targetPos);
...
//         // Use collider bounds to stop just outside
//         Collider targetCollider = currentTarget.GetComponent<Collider>();
//         Vector3 direction = (currentTarget.transform.position - transform.position).normalized;

//         if (targetCollider != null)
//             targetPos = targetCollider.ClosestPoint(transform.position) - direction * 0.05f; // tiny buffer
//         else
...
//         // Slow down if very close to avoid overshoot
//         float distanceToTarget = Vector3.Distance(transform.position, targetPos);
//         if (distanceToTarget < 0.2f)
//             agent.speed = Mathf.Min(agent.speed, 0.1f);
//         else
//             agent.speed = data.MovementSpeed;
//     }
...
//     //     // If attacking animals, only allow adjacent grid positions
//     //     if (currentTarget is ArmyUnit)
//     //     {
//     //         if (!IsAdjacentToTarget(currentTarget))
//     //             return;
//     //     }

//     //     // For other targets (buildings, structures), check collider distance
//     //     Collider enemyCollider = GetComponent<Collider>();
//     //     Collider targetCollider = currentTarget.GetComponent<Collider>();
...
//         // Only attack animals if adjacent
//         if (currentTarget is ArmyUnit && !IsAdjacentToTarget(currentTarget))
//             return;
...
//         if (distanceBetween <= attackRange && Time.time >= lastAttackTime + data.AttackCooldown)
//         {
//             lastAttackTime = Time.time;
//             SetTrigger("Attack");
//             Attack(currentTarget);
...
//                 break;
//         }
//         Debug.Log("wolf attacked " + target.name);
//     }
